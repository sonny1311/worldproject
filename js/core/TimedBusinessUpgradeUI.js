...
export function openTimedBusinessUpgradeCenter(){
 ...
 const note=document.createElement('div');note.innerHTML='<b>⏱️ Keine Sofort-Upgrades.</b><br><span>Bezahlen startet Umbau, Schulung und Abnahme. Erst danach wird die neue Stufe aktiv. Höhere Stufen dauern länger; Freundeshilfe kann die Zeit begrenzt verkürzen.</span>';Object.assign(note.style,{padding:'12px',border:'1px solid #334155',background:'#111827',borderRadius:'10px',marginBottom:'14px',color:'#e2e8f0'});box.append(note);
