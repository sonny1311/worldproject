// WorldProject - lokaler Entwicklungs-Fallback fuer Coin-Angebote ueber F5.
// Wird deaktiviert, sobald ein echter serverseitiger Coin-Markt aktiv ist.
import { ensureCoinExchange } from './PlayerCoinMarketExchange.js';
const KEY='worldproject:player-coin-market:v1';
...
if(typeof window!=='undefined'){window.worldLocalCoinMarketPersistence={save:saveLocalCoinMarket,restore:restoreLocalCoinMarket,rebuild:rebuildCoinMarketReservations,test:runLocalCoinMarketPersistenceTest};installLocalCoinMarketPersistence();}
