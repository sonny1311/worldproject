...
if(!proto.__orvunoStickyCloseIntegrated){
 ...
 proto.open=async function(...args){
  ...
  if(panel){panel.dataset.orvunoBusinessPortfolioPanel='1';Object.assign(panel.style,{position:'relative',isolation:'isolate'});}
  if(head){
   ...
   if(close)Object.assign(close.style,{position:'relative',zIndex:'100001',fontSize:'22px',minWidth:'44px',minHeight:'44px',pointerEvents:'auto'});
  }
  return result;
 };
}
