...
// Öffnet nur bereits vorhandene Bereiche; verändert keine Bestände und führt keine Aktion automatisch aus.
...
function addPremiumNavigation(dashboard,card){
  ...
  const items=[...card.querySelectorAll('.world-production-readiness-checklist .production-readiness-row')];
...
if(!proto.__productionReadinessPremiumNavigationV2){
  proto.__productionReadinessPremiumNavigationV2=true;
