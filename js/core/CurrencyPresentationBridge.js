...
export function playerMoneyContext(account=null){const a=account||globalThis.worldAccount||globalThis.worldPlayerAccount||{};const country=String(a.country||a.countryCode||worldCurrency.country||'DE').toUpperCase();const currency=a.currency||currencyForCountry(country);return{country,currency};}
