// ORVUNO - Bedienbarkeit langer Verwaltungsfenster.
...
function enhanceCloseHeader(panel){
 ...
 if(overlay){Object.assign(overlay.style,{alignItems:"flex-start",justifyContent:"center",padding:"92px 20px 20px",boxSizing:"border-box"});}
 Object.assign(panel.style,{maxHeight:"calc(100vh - 112px)",background:"#111827",color:"#f8fafc",border:"1px solid #334155",boxSizing:"border-box"});
 const head=close.parentElement;
 if(!head)return false;
 Object.assign(head.style,{position:"sticky",top:"0",zIndex:"40",background:"#111827",padding:"8px 0",borderBottom:"1px solid #334155"});
 Object.assign(close.style,{zIndex:"50",background:"#1e293b",color:"#f8fafc",border:"1px solid #64748b",fontSize:"20px",lineHeight:"1",padding:"9px 12px"});
 return true;
}
