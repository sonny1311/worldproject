...
function runAdminStartupRegressions(){
  ...
  try{
    ...
    return {regression,auditRegression,roleRegression,currencyRegression,operationsExpansionRegression};
  } finally {
...
export async function startWorldProjectAdmin({actor,context={},loadAdminUi=null,mount=null}={}){
  ...
  const {regression,auditRegression,roleRegression,currencyRegression,operationsExpansionRegression}=runAdminStartupRegressions();
  ...
  let ui=null;
  if(typeof loadAdminUi==="function")await loadAdminUi({actor,adminControlSystem,frontend,workspace,regression,auditRegression,roleRegression,currencyRegression,operationsExpansionRegression});
