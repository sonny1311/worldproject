...
export const BaseGameContent={
 materials:[
  {id:"malt",label:"Malz",unit:"kg",storageZone:"raw"},{id:"hops",label:"Hopfen",unit:"kg",storageZone:"raw"},{id:"yeast",label:"Hefe",unit:"kg",storageZone:"cold"},{id:"water",label:"Wasser",unit:"l",storageZone:"raw"},{id:"bottles",label:"Leergut / gebrauchte 0,33-l-Flaschen",unit:"Stk",storageZone:"packaging"},{id:"clean_bottles",label:"Gereinigte 0,33-l-Flaschen",unit:"Stk",storageZone:"packaging"},{id:"caps",label:"Kronkorken",unit:"Stk",storageZone:"packaging"},{id:"labels",label:"Etiketten",unit:"Stk",storageZone:"packaging"},{id:"bottle_wash_chem",label:"Flaschenreiniger",unit:"kg",storageZone:"raw"},{id:"beer_bulk_pils",label:"Pils - Flüssigware",unit:"l",storageZone:"finished"},{id:"beer_bulk_lager",label:"Lagerbier - Flüssigware",unit:"l",storageZone:"finished"},
 ...
 suppliers:[
  ...
  {id:"brew_packaging",industries:["brewery","beverage"],label:"Getraenkeverpackung West",materials:["bottles","clean_bottles","caps","labels","bottle_wash_chem"],prices:{bottles:.10,clean_bottles:.17,caps:.025,labels:.09,bottle_wash_chem:2.8},distanceKm:64,deliveryBase:50,deliveryPerKm:.50,deliveryHours:10,quality:.96,reliability:.98},
 ...
 recipes:[
  ...
  {id:"beer_basic",industries:["brewery"],label:"Bier 0,33 l (Altbestand)",materials:{malt:100,hops:2,yeast:1,water:700,clean_bottles:1000,caps:1000,labels:1000},machineType:"brewhouse",durationMinutes:180,output:1000,outputUnit:"Flaschen",product:"beer_basic",variableCost:90,deprecated:true},
  {id:"brew_pils",industries:["brewery"],label:"Pils brauen",materials:{malt:100,hops:2.2,yeast:1,water:700},machineType:"brewhouse",durationMinutes:180,output:1000,outputUnit:"l",product:"beer_bulk_pils",variableCost:74,productionStage:"brewing"},
  {id:"brew_lager",industries:["brewery"],label:"Lagerbier brauen",materials:{malt:96,hops:1.7,yeast:1,water:700},machineType:"brewhouse",durationMinutes:190,output:1000,outputUnit:"l",product:"beer_bulk_lager",variableCost:71,productionStage:"brewing"},
  {id:"fill_pils_033",industries:["brewery"],label:"Pils 0,33 l abfüllen",materials:{beer_bulk_pils:330,clean_bottles:1000,caps:1000,labels:1000},machineType:"filling_line",durationMinutes:60,output:1000,outputUnit:"Flaschen",product:"beer_pils_033",variableCost:18,productionStage:"bottling",bottleSizeLiters:.33},
  {id:"fill_lager_033",industries:["brewery"],label:"Lagerbier 0,33 l abfüllen",materials:{beer_bulk_lager:330,clean_bottles:1000,caps:1000,labels:1000},machineType:"filling_line",durationMinutes:60,output:1000,outputUnit:"Flaschen",product:"beer_lager_033",variableCost:18,productionStage:"bottling",bottleSizeLiters:.33},
 ...
 products:[
  {id:"clean_bottles",industries:["brewery"],label:"Gereinigte Flaschen",unit:"Flaschen"},{id:"beer_basic",industries:["brewery"],label:"Bier 0,33 l",unit:"Flaschen"},{id:"beer_bulk_pils",industries:["brewery"],label:"Pils - Flüssigware",unit:"l",sellable:false},{id:"beer_bulk_lager",industries:["brewery"],label:"Lagerbier - Flüssigware",unit:"l",sellable:false},{id:"beer_pils_033",industries:["brewery"],label:"Pils 0,33 l",unit:"Flaschen",bottleSizeLiters:.33},{id:"beer_lager_033",industries:["brewery"],label:"Lagerbier 0,33 l",unit:"Flaschen",bottleSizeLiters:.33},{id:"table_basic",industries:["carpentry"],label:"Tisch",unit:"Stk"},{id:"wheat",industries:["farm"],label:"Weizen",unit:"kg"},{id:"barley",industries:["farm"],label:"Gerste",unit:"kg"}
 ]
};
