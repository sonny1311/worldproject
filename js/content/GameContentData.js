...
export const BaseGameContent={
 materials:[
  {id:"malt",label:"Malz",unit:"kg",storageZone:"raw"},{id:"hops",label:"Hopfen",unit:"kg",storageZone:"raw"},{id:"yeast",label:"Hefe",unit:"kg",storageZone:"cold"},{id:"water",label:"Wasser",unit:"l",storageZone:"raw"},{id:"bottles",label:"Leergut / gebrauchte 0,33-l-Flaschen",unit:"Stk",storageZone:"packaging"},{id:"clean_bottles",label:"Gereinigte 0,33-l-Flaschen",unit:"Stk",storageZone:"packaging"},{id:"caps",label:"Kronkorken",unit:"Stk",storageZone:"packaging"},{id:"labels",label:"Etiketten",unit:"Stk",storageZone:"packaging"},{id:"bottle_wash_chem",label:"Flaschenreiniger",unit:"kg",storageZone:"raw"},
 ...
 machines:[
  {id:"brewhouse",industries:["brewery"],label:"Sudhaus"},{id:"bottle_washer",industries:["brewery"],label:"Flaschenwaschanlage"},{id:"woodshop",industries:["carpentry"],label:"Werkstattlinie"},{id:"field_line",industries:["farm"],label:"Ackerbau-Maschinenkette"}
 ],
 recipes:[
  {id:"wash_bottles",industries:["brewery"],label:"Leergut reinigen",materials:{bottles:1000,bottle_wash_chem:1,water:250},machineType:"bottle_washer",durationMinutes:60,output:1000,product:"clean_bottles",variableCost:12},
  {id:"beer_basic",industries:["brewery"],label:"Bier Grundcharge",materials:{malt:100,hops:2,yeast:1,water:700,clean_bottles:1000,caps:1000,labels:1000},machineType:"brewhouse",durationMinutes:180,output:1000,product:"beer_basic",variableCost:90},
 ...
 products:[
  {id:"clean_bottles",industries:["brewery"],label:"Gereinigte Flaschen",unit:"Flaschen"},{id:"beer_basic",industries:["brewery"],label:"Bier 0,33 l",unit:"Flaschen"},{id:"table_basic",industries:["carpentry"],label:"Tisch",unit:"Stk"},{id:"wheat",industries:["farm"],label:"Weizen",unit:"kg"},{id:"barley",industries:["farm"],label:"Gerste",unit:"kg"}
 ]
};
